public class TicTacToeUC9 {
    ...
    // Simulating a board where 'X' has won across the top row
    static char[][] board = {
            {'X', 'X', 'X'},
            {'-', 'O', '-'},
            {'-', '-', 'O'}
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Has 'X' won? " + hasWon('X')); // Expected true
        System.out.println("Has 'O' won? " + hasWon('O')); // Expected false
    }
